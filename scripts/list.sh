...
show_version "delta" 1 "delta --version"
...
show_version "dockerfmt" 1 "dockerfmt version"
...
show_version "markdownlint-cli2" 1 "markdownlint-cli2 --version"
show_version "mise" 1 "mise --version"
...
show_version "ruff" 1 "ruff --version"
